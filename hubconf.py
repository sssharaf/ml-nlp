...
class MyModel3(nn.Module):
    def __init__(self, freeze_bert=True):
        ...
        self.action_cls_lyr = nn.Sequential(
            ...
            nn.ReLU(),
            nn.LayerNorm(64),
            nn.Linear(64, len(MODEL3_ACTIONS), bias=True),
            nn.LayerNorm(len(MODEL3_ACTIONS)),
        ...
        self.component_cls_lyr = nn.Sequential(
            ...
            nn.ReLU(),
            nn.LayerNorm(64),
            nn.Linear(64, len(MODEL3_COMPONENTS), bias=True),
            nn.LayerNorm(len(MODEL3_COMPONENTS)),
